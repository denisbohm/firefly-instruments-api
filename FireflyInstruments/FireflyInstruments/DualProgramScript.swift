...
open class DualProgramScript: FixtureScript, Script {
    ...
    public init(fixture: Fixture, presenter: Presenter, nrf5Boot: IntelHex, nrf5Application: IntelHex, nrf5Softdevice: IntelHex, serialNumber: UInt32, apolloApplication: IntelHex) {
