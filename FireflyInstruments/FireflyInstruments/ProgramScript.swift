...
open class ProgramScript: SerialWireDebugScript, Script {
    ...
    public init(fixture: Fixture, presenter: Presenter, serialWireInstrumentIdentifier: String, boot: IntelHex, application: IntelHex, softdevice: IntelHex, serialNumber: UInt32) {
